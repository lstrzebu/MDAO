...
if continue_mission_analysis.value
    ...
    mission(3).physics.X_NP.units = 'm';
    mission(3).physics.X_NP.type = "length";
    mission(3).physics.X_NP.description = "X location of neutral point according to AVL coordinate system: x positive rear, y positive to the right hand wing, and z positive up. Origin at x = LE of wing, y dividing the aircraft symmetrically in two, and z in line with the motor shaft axis.";
    mission(3).physics.CL_trim(1).units = '';
    mission(3).physics.CL_trim(1).type = "non";

    mission(3).physics.CL_trim(1).description = "total trimmed lift coefficient of aircraft (from static stability analysis)";
    mission(3).physics.v_trim.units = 'm/s';
    mission(3).physics.v_trim.type = "vel";
    mission(3).physics.v_trim.description = "freestream velocity during trimmed flight (from static stability function)";
    mission(3).physics.alpha_trim.units = 'deg';
    mission(3).physics.alpha_trim.type = "ang";
    mission(3).physics.alpha_trim.description = "angle of attack (with respect to fuselage reference line) during trimmed flight";
    mission(3).physics.stability.static.failure.units = '';
    mission(3).physics.stability.static.failure.type = "non";
    mission(3).physics.stability.static.failure.description = "discrete value indicating the presence and mode of static failure: 0 = statically stable, 1 = inadequate pitching moment coefficient gradient (bad Cm_alpha), and 2 = inadequate trimmed lift coefficient (bad CL_trim)";
    ...
    unitsAgree = [strcmp(string(aircraft.loaded.XYZ_CG.units), "m");
        ...
        strcmp(string(mission(3).weather.air_density.units), "kg/m^3")];
    ...
    if all(unitsAgree)
        ...
        [mission(3).physics.X_NP.value,...
            mission(3).physics.CL_trim(1).value,...
            mission(3).physics.v_trim.value,...
            mission(3).physics.alpha_trim.value,...
            mission(3).physics.stability.static.failure.value,...
            ...
            mission(3).weather.air_density.value); % kg/m^3
    else
    ...
    if mission(3).physics.stability.static.failure.value ~= 0
...
if continue_mission_analysis.value
    ...
    structNames = ["mission(3).physics.alpha_trim";
        "aircraft.wing.alpha_0L_wb"];
    desiredUnits = ["rad";
        "rad"];
    ...
    unitsAgree = [strcmp(string(aircraft.wing.b.units), "m");
        ...
        strcmp(string(mission(3).physics.alpha_trim.units), "rad");
        strcmp(string(aircraft.wing.a0.units), "/rad");
        strcmp(string(aircraft.wing.alpha_0L_wb.units), "rad");
        strcmp(string(mission(3).physics.v_trim.units), "m/s");
    ...
    if all(unitsAgree)
        ...
        [mission(3).physics.G.max.value, ...
            ~, ...
            ~, ...
            mission(3).structures.num_fasteners.minimum.value, ...
            mission(3).physics.turn_radius.minimum.value, ...
            mission(3).physics.bank_angle.maximum.value, ...
            mission(3).physics.CL_trim(3).value] = structures_MDAO(aircraft.wing.b.value, ...
        ...
        mission(3).physics.G.max.units = 'G''s';
        mission(3).physics.G.max.type = "acc";
        mission(3).physics.G.max.description = "maximum number of G's the airframe can withstand (estimated) during the mission(3)";
        mission(3).structures.num_fasteners.minimum.units = '';
        mission(3).structures.num_fasteners.minimum.type = "non";
        mission(3).structures.num_fasteners.minimum.description = "minimum number of fasteners required to avoid wing pullout (conservative estimate)";
        mission(3).physics.turn_radius.minimum.units = 'm';
        mission(3).physics.turn_radius.minimum.type = "length";
        mission(3).physics.turn_radius.minimum.description = "minimum turn radius corresponding to maximum bank angle for the present mission(3)";
        mission(3).physics.bank_angle.maximum.units = "deg";
        mission(3).physics.bank_angle.maximum.type = "ang";
        mission(3).physics.bank_angle.maximum.description = "maximum bank angle corresponding to minimum turn radius for the present mission(3)";
        mission(3).physics.CL_trim(3).units = '';
        mission(3).physics.CL_trim(3).type = "non";
        mission(3).physics.CL_trim(3).description = "trimmed lift coefficient outputted from Lift_Distr function called in structural analysis";
    else
    ...
    if mission(3).physics.turn_radius.minimum.value < 0 || mission(3).structures.num_fasteners.minimum.value > constants.wing.max_num_fasteners.value || mission(3).physics.bank_angle.value > 90
        continue_mission_analysis.value = false;
        if mission(3).structures.num_fasteners.minimum.value > constants.wing.max_num_fasteners.value
            failure_message = sprintf("Design would notionally require at least %d fasteners, more than the allotted maximum of %d.", mission(3).structures.num_fasteners.minimum.value, constants.wing.max_num_fasteners.value);
...
if continue_mission_analysis.value
    ...
    unitsAgree = [strcmp(string(aircraft.unloaded.weight.units), "N");
        strcmp(string(mission(3).physics.v_trim.units), "m/s");
        strcmp(string(mission(3).physics.CL_trim.units), "");
        strcmp(string(aircraft.wing.b.units), "m");
        strcmp(string(aircraft.wing.c.units), "m");
        strcmp(string(aircraft.tail.horizontal.b.units), "m");
        strcmp(string(aircraft.tail.horizontal.c.units), "m");
        ...
        strcmp(string(mission(3).physics.alpha_trim.units), "deg");
    ...
    if all(unitsAgree)
        ...
        [mission(3).physics.L(1).value, ...
            mission(3).physics.L(2).value, ...
            mission(3).physics.D.value, ...
            mission(3).physics.CD_trim.value, ...
            mission(3).physics.CL_trim(2).value, ...
            mission(3).physics.v_stall.value, ...
            speed_boolean, ...
        ...
        mission(3).physics.L(1).units = 'N';
        mission(3).physics.L(1).type = "force";
        mission(3).physics.L(1).description = "trimmed lift";

        mission(3).physics.L(2).units = 'N';
        mission(3).physics.L(2).type = "force";
        mission(3).physics.L(2).description = "trimmed lift (alternate method)";

        mission(3).physics.D.units = 'N';
        mission(3).physics.D.type = "force";
        mission(3).physics.D.description = "drag force during trimmed flight";

        mission(3).physics.CD_trim.units = '';
        mission(3).physics.CD_trim.type = "non";
        mission(3).physics.CD_trim.description = "drag coefficient during trimmed flight";

        mission(3).physics.CL_trim(2).units = '';
        mission(3).physics.CL_trim(2).type = "non";
        mission(3).physics.CL_trim(2).description = "trimmed lift coefficient (from aerodynamics analysis)";

        mission(3).physics.v_stall.units = 'm/s';
        mission(3).physics.v_stall.type = "vel";
        mission(3).physics.v_stall.description = "stall speed of 3D aircraft";
    else
...
if continue_mission_analysis.value
    ...
    unitsAgree = [strcmp(string(aircraft.unloaded.weight.units), "N");
        strcmp(string(mission(3).physics.D.units), "N");
    ...
    if all(unitsAgree)
        ...
        [aircraft.physics.P_trim.value, ...
            ...
            mission(3).physics.TW_ratio.value, ...
            mission(3).physics.RPM.value, ...
            mission(3).physics.propulsion.FOS.value, ...
            safetyCheck, ...
        ...
        mission(3).physics.TW_ratio.units = '';
        mission(3).physics.TW_ratio.type = "non";
        mission(3).physics.TW_ratio.description = "thrust-to-weight ratio of aircraft for the current mission(3) being considered. Note that this will change from mission(3) to mission(3)";
        mission(3).physics.RPM.units = "RPM";
        mission(3).physics.RPM.type = "angvel"; % angular velocity dimensional type
        mission(3).physics.RPM.description = "RPM of motor in cruise for the mission(3) being considered";
        mission(3).physics.propulsion.FOS.units = '';
        mission(3).physics.propulsion.FOS.type = "non";
        mission(3).physics.propulsion.FOS.description = "factors of safety of the Voltage, Current, and Power for the propulsion system";
    else
